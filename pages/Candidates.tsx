    ...
    <div className="space-y-6 relative h-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">Visualize diagnósticos e tome decisões rápidas.</p>
        </div>
              ...
              {filteredCandidates.map((candidate) => (
                ...
                >
                  <td className="px-6 py-4">
                    ...
                    <div className="text-xs text-slate-500 dark:text-slate-400">{candidate.phone}</div>
                  </td>
                  <td className="px-6 py-4">
                    {candidate.score > 0 ? (
