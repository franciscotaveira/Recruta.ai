      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
                  Seus Currículos Rejeitados por <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">ATS?</span>
              </h1>
              
              {/* Subheadline */}
              <p className="text-xl md:text-2xl text-gray-300 mb-12 leading-relaxed">
                  IA reescreve seu currículo para passar nos filtros automáticos de <strong className="text-white">75% das empresas</strong>. Resultados em 2 minutos.
              </p>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-slate-900 border border-slate-700 rounded-lg p-8 text-center hover:border-purple-500 transition">
                  ...
                  <p className="text-gray-400">Cole o texto ou faça upload em PDF/DOCX. Leva menos de 1 minuto.</p>
              ...
              <div className="bg-slate-900 border border-slate-700 rounded-lg p-8 text-center hover:border-purple-500 transition">
                  ...
                  <p className="text-gray-400">Detecta problemas no ATS, palavras-chave faltantes e score de competitividade.</p>
              ...
              <div className="bg-slate-900 border border-slate-700 rounded-lg p-8 text-center hover:border-purple-500 transition">
                  ...
                  <p className="text-gray-400">Baixe seu currículo reescrito, pronto para enviar aos recrutadores.</p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                  {features.map((feature, idx) => (
                      <div key={idx} className="bg-slate-900 border border-slate-700 rounded-lg p-8 hover:border-purple-500 hover:shadow-lg hover:shadow-purple-500/10 transition">
  ...
  const testimonials = [
      {
          ...
          content: 'Meu currículo passava em 20% dos filtros. Depois de usar Recruta.AI, passei em 85%. Consegui 3 entrevistas em 1 semana!',
          avatar: '👨‍💻'
      },
      {
          name: 'Maria Santos',
          role: 'Product Manager',
          content: 'Sempre achei que meu currículo era bom. Depois vi que estava perdendo 60% das oportunidades. Agora meu score é 92%',
          avatar: '👩‍💼'
      },
      {
          name: 'Pedro Costa',
          role: 'Data Scientist',
          content: 'A análise de competitividade foi surpreendente. Agora entendo exatamente onde melhorar para ser contratado.',
          avatar: '👨‍🔬'
      }
  ];
...
const PricingSection = ({ onSelect }: { onSelect: (plan: string) => void }) => (
  <section className="py-20 bg-slate-950 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-slate-900 border border-slate-700 rounded-lg p-8 hover:border-purple-500 transition">
                  ...
                  <p className="text-4xl font-bold mb-6">R$ 49<span className="text-lg text-gray-400">/mês</span></p>
                  
                  <ul className="space-y-4 mb-8">
                      <li className="flex items-center"><span className="text-green-400 mr-3">✓</span> 5 análises por mês</li>
                      <li className="flex items-center"><span className="text-green-400 mr-3">✓</span> 1 versão do currículo</li>
                      <li className="flex items-center"><span className="text-green-400 mr-3">✓</span> Feedback básico</li>
                      <li className="flex items-center"><span className="text-gray-600 mr-3">✗</span> Integração ATS</li>
                      <li className="flex items-center"><span className="text-gray-600 mr-3">✗</span> Suporte 24/7</li>
                  </ul>
              ...
              <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-lg p-8 transform hover:scale-105 transition">
                  ...
                  <p className="text-4xl font-bold mb-6">R$ 199<span className="text-lg text-white/80">/mês</span></p>
                  
                  <ul className="space-y-4 mb-8">
                      <li className="flex items-center"><span className="text-white mr-3">✓</span> Análises ilimitadas</li>
                      <li className="flex items-center"><span className="text-white mr-3">✓</span> 10+ versões</li>
                      <li className="flex items-center"><span className="text-white mr-3">✓</span> Feedback avançado</li>
                      <li className="flex items-center"><span className="text-white mr-3">✓</span> Integração ATS (Gupy)</li>
                      <li className="flex items-center"><span className="text-white mr-3">✓</span> Suporte 24/7</li>
                  </ul>
  ...
  const faqs = [
      {
          ...
          answer: 'Seus dados são criptografados em repouso. Você controla 100% quem acessa. Estamos em conformidade LGPD total.'
      },
      {
          id: '2',
          question: '❓ A IA modifica meu estilo?',
          answer: 'Não. Apenas otimizamos formatação, palavras-chave e estrutura, mantendo sua voz e personalidade.'
      },
      {
          id: '3',
      ...
      <section className="py-20 bg-slate-950 text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
              ...
              <div className="space-y-4">
                  {faqs.map((faq) => (
                      <div key={faq.id} className="bg-slate-900 border border-slate-700 rounded-lg overflow-hidden">
                          <button
  ...
  <section className="py-20 bg-gradient-to-r from-purple-600 to-pink-600 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/80">
              Leva 2 minutos. Sem cartão de crédito.<br/>
