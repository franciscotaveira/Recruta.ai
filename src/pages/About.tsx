...
const About = () => {
  usePageMeta({
    title: 'Sobre a Recrutaria | Nossa Missão e Tecnologia',
    description:
      'A Recrutaria nasceu da frustração de ver talentos incríveis sendo descartados por robôs. Democratizamos o acesso a grandes oportunidades usando IA.',
    canonicalUrl: 'https://recrutaria.com.br/sobre',
    keywords: 'sobre a recrutaria, missão, tecnologia rh, ia no recrutamento, empresa recrutaria',
    jsonLdSchema: {
      '@context': 'https://schema.org',
      '@type': 'Organization',
      name: 'Recrutaria',
      url: 'https://recrutaria.com.br',
      logo: 'https://recrutaria.com.br/og-image.jpg',
      description:
        'A Recrutaria democratiza o acesso a oportunidades de emprego utilizando inteligência artificial para análise comportamental.',
      foundingDate: '2026',
    },
  });
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <section className="py-20 px-4 text-center max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-7xl font-black text-slate-900 mb-8 tracking-tighter font-heading leading-[0.9]">
          ...
          do que palavras-chave em um PDF.
        </h1>
