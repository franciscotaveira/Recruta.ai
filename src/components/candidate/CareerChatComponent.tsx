      ...
      <div className="flex-1 flex flex-col relative h-full">
        ...
        >
          {messages.map((msg) => (
            ...
            >
              <div
                className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 shadow-2xl border ${
                  msg.role === 'ai'
              ...
              >
                <div
                  className={`p-5 rounded-2xl text-sm leading-relaxed shadow-xl whitespace-pre-wrap ${
                    msg.role === 'ai'
