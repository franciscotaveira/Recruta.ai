...
const CreditActivationModal: React.FC<Props> = ({
  isOpen,
  onClose,
  onConfirm,
  candidateName,
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-md border border-slate-200 dark:border-slate-700 overflow-hidden transform transition-all scale-100">
        ...
        <div className="p-6">
          <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-6">
            Você está prestes a desbloquear os dados de contato (WhatsApp/Email) e habilitar o
            convite para entrevista de{' '}
            <strong className="text-slate-900 dark:text-white">{candidateName}</strong>.
          </p>
