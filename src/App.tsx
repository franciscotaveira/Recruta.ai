...
const FeaturePlaceholder = ({
  ...
  <div className="flex flex-col items-center justify-center h-full min-h-[60vh] text-center p-8 animate-fade-in-up">
    ...
    <button
      ...
      className="mt-8 px-6 py-2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold rounded-lg text-sm hover:opacity-90 transition-opacity"
    >
      Voltar ao Dashboard
    </button>
  </div>
      ...
      <DataProvider>
        <HashRouter>
          ...
          <Routes>
            ...
            {/* Recruiter Routes (B2B) — protected */}
            <Route
              path="/recruiter/*"
              element={
            ...
            {/* Candidate Routes (B2C) — protected */}
            <Route
              path="/candidate/*"
              element={
