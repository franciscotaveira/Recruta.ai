...
const PACKAGES = {
  starter: { credits: 50, price: 199.0 },
  growth: { credits: 200, price: 699.0 },
  scale: { credits: 1000, price: 2990.0 },
};
  ...
  try {
    ...
    const response = await fetch('https://api.abacatepay.com/v1/billing/create', {
      ...
      body: JSON.stringify({
        ...
        completionUrl:
          Deno.env.get('FRONTEND_URL') || 'http://localhost:4050/recruiter/billing?success=true',
    ...
    return new Response(JSON.stringify({ ok: true, checkoutUrl: billing.url }), {
